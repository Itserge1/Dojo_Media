...
module.exports = app => {
    ...
    app.patch("/api/update/profilepicture/:_id", userControllers.UpdateUserProfilePicture);
    app.patch("/api/update/coverpicture/:_id", userControllers.UpdateUserCoverPicture);

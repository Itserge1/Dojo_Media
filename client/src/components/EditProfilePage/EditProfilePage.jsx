...
const EditProfilePage = () => {
    ...
    const UpdateLoggedUserCoverOrProfilePic = async (event) => {
        ...
        if (profilePicFile === null) {
            ...
            axios.patch(`${process.env.REACT_APP_API_LINK}/api/update/coverpicture/${LoggedInUser._id}`, newObject, { withCredentials: true })
                .then(res => {
            ...
            axios.patch(`${process.env.REACT_APP_API_LINK}/api/update/profilepicture/${LoggedInUser._id}`, newObject, { withCredentials: true })
                .then(res => {
    ...
    // Delete
    const deleteUser = () => {
        axios.delete(`${process.env.REACT_APP_API_LINK}/api/delete/${LoggedInUser._id}`)
            .then(res => {
            ...
            <div className="conatainer-info-form">
                ...
                <form onSubmit={UpdateLoggedUserCoverOrProfilePic}  >
                    <div className="file-form" style={{ width: "100%" }}>
                        ...
                        <div className="input-div" >
                            <label className="file-input" htmlFor="coverPicture"> Cover Picture <IoMdPhotos className="IoMdPhotos" /> </label>
                        ...
                        <button type="submit" className="btn2 btn-primary">Update cover Picture</button>
                    </div>
                </form>
            </div>
